      ...
      <>
        ...
        <section className='bg-neucomOrange row-start-1 row-end-6 col-start-2 col-span-3 flex flex-col justify-start items-center'>
          <div className='w-full grow flex flex-col justify-start items-center'>
            ...
            <div className='bg-neucomOrange2 w-5/6 mt-10 pt-8 text-center text-white text-xs leading-3 rounded-t-[2.5rem] tracking-widest md:leading-3 grow md:w-4/6 md:text-sm'>
        ...
        <div className='col-start-5 col-span-1 grid grid-cols-3 row-start-1 row-end-6'>
          <div className='bg-neucomOrange3'></div>
          <div className='bg-neucomOrange4'></div>
          <div className='bg-neucomOrange2'></div>
        </div>
      </>
    </Layout>
  );
