  ...
  return (
    <div className='bg-[#006679] w-screen h-screen grid grid-cols-6 grid-rows-6'>
      ...
      <div className='col-start-1 col-end-2 row-start-1 row-end-7 grid grid-cols-12 grid-rows-6'>
        ...
        <div className='col-start-2 col-end-5 row-start-3 row-end-6 flex justify-center items-start'>
          <div className='text-[#00BDCB] text-sm vertical-rl font-semibold italic'>
            Oriental Computer USEA 2043.
          </div>
          <div className='text-[#00BDCB] text-lg vertical-rl font-bold italic'>
      ...
      <div className='w-11/12 row-start-1 row-end-3 col-start-2 col-end-7 flex items-end'>
        <div className='relative bg-[#000] w-11/12 h-2/3 rounded-r-[3rem] border-r-[0.75rem] border-y-[0.5rem] border-[#00B5C3] flex pl-8 justify-start items-center'>
