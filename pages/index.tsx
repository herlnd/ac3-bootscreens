...
export default function Home() {
  return (
    <div className='bg-[#006679] w-screen h-screen grid grid-cols-6 grid-rows-6'>
      <div className='bg-[#000] row-start-1 row-end-7'></div>
      <div className='w-11/12 row-start-1 row-end-3 col-start-2 col-end-7 flex items-end'>
        <div className='relative bg-[#000] w-11/12 h-3/4 rounded-r-[3rem] border-r-[0.75rem] border-y-[0.5rem] border-[#00B5C3]'>
