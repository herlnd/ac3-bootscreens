...
import PluginsIconsHorizontal from './PluginsIcons/PluginsIconsHorizontal.module';
    ...
    <section className='bg-[#F0F0E0] col-start-1 col-span-full row-start-4 row-span-full md:col-start-4 md:row-start-1 md:col-span-2 md:h-screen grid grid-rows-5 grid-cols-5 '>
      <div className='col-start-2 col-span-full row-start-2 row-end-3 flex justify-end items-start md:col-start-4 md:col-end-5 md:row-start-1 md:row-end-4 md:flex md:justify-end'>
        <div className='md:w-1/2 md:h-full md:flex md:items-end md:justify-end '>
          <p className='text-sm font-semibold pr-2 md:pr-0 md:block md:pt-4 md:text-base md:text-left md:vertical-rl md:transform md:rotate-180'>
            PLUG IN FILES
          </p>
        </div>
      </div>
      <div className='col-start-2 col-span-full row-start-1 row-end-2 border-l-2 border-b-2 border-black flex items-center justify-end pr-2 md:pr-0 md:pl-4 md:col-start-5 md:col-end-6 md:row-start-1 md:row-end-4 md:pb-4 md:items-end md:justify-start md:border-l-2'>
        <div className='hidden md:block md:w-1/2'>
          <PluginsIcons />
        </div>
        <div className='w-11/12 md:hidden'>
          <PluginsIconsHorizontal />
        </div>
      </div>
